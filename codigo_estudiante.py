...
ruta = "C:/Users/Estudiantes/Documents/GitHub\introduccion-a-github-y-a-vision-por-computador-Daniel-Gbot/data/imagen0.png"
...
def imagen_a_arreglo(img):
    ...
    print(f"Arreglo de imagen: {arreglo.shape}")
    return arreglo
